...
interface QueryInterface
{
     ...
     * @return  Command\Credential\Grant
     */
     ...
     *
     * @param   string  $permission
     * @return  Command\Credential\Revoke
     */
